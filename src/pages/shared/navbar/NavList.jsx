    ...
    <ul className="my-2 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        <NavLink
          ...
          className={({ isActive }) =>
            isActive
              ? "flex items-center text-blue-500 transition-colors"
        ...
        <>
          ...
          >
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ? "flex items-center text-blue-200 transition-colors"
                  : "flex items-center hover:text-blue-500 transition-colors"
              }
            >
          ...
          >
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ? "flex items-center text-blue-500 transition-colors"
                  : "flex text-primary items-center hover:text-blue-500 transition-colors"
              }
            >
