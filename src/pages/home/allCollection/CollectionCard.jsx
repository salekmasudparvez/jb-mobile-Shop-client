...
const CollectionCard = ({ product }) => {
    ...
    //console.log(daysAgo)
    return (
        <div className="md:w-[194px] relative cursor-pointer bg-white hover:shadow-md shadow-black hover:border-2">
            <img className='w-[194px]' src={imageURL} alt="" />
            <div className='flex justify-center items-center gap-1 text-yellow-700 border absolute top-1 px-2 text-sm bg-white rounded-3xl right-1'>
            ...
            <div className='flex justify-center items-center gap-1 text-blue-500 border absolute top-1 px-2 text-sm bg-white rounded-3xl left-1'>
                <span>
